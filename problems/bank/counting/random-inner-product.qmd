...
$$
s=a_1b_1+a_2b_2+\cdots +a_{10}b_{10},
$$

what is the probability that the sum $s$ is equal to $k$, for some $k=0,\,1,\,2,\,3,\,...,\,10$?

a. Derive a generic formula for $P(s=k)$ that is a function of $k$, but then plug into your formula and produce the $10\times 2$ table containing the actual decimal numbers for each $k$;
