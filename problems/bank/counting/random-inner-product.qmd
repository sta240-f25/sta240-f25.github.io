...
a. Derive a generic formula for $P(s=k)$ that is a function of $k$, but then plug into your formula and produce the $11\times 2$ table containing the actual decimal numbers for each $k$;
