...
e.  Let's say that we consider the probability of reversal "too big" if it is greater than 5%. Create a plot in `R` like @fig-elections with the following features:
