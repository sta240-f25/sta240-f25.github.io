...
**Task**: Derive a general formula for the *conditional* probability that a dart lands in ring $i$ given that it hits the board and not the wall. Your formula should be a function of $i=1,\,2,\,3,\,4,\,5$. Check that these probabilities are nonnegative and sum to one. Verify that these probabilities sum to one.
