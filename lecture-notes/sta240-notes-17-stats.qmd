...
Here, $f$ is generic notation for *either* a PMF or PDF. If you're willing to swallow this parametric assumption, the goal of statistical inference becomes "using the data to learn the value of the unknown parameter $\theta$."
