...
Below, I reproduce several examples where we computed the MGF of a distribution, and I point out that we basically followed the same steps in each case. The unifying theme here is [*kernel tricks*](https://sta240-f25.github.io/math/massage-and-squint.html).
