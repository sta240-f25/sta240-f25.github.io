...
- *Differentiation* is a forward problem. You grab the function, and you take the darn derivative;

- *Integration* is an inverse problem. You have to muse "If this is the derivative, then what was the original function?"
...
Like all inverse problems, you will find that statistics is subtler, less well-defined, and less straightforward than probability.
