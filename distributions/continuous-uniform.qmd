...
[Here](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/Uniform.html) is the documentation for the suite of commands that let you work with the normal distribution in `R`:
