...
A point like $x=0$ in this example where the second derivative changes sign and the concavity changes is called an **inflection point**. "Second derivative changes sign" is the same thing as saying the graph of $f''$ crosses the $x$-axis, so an inflection point happens where the second derivative has roots: $f''=0$. 
