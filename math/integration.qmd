...
Through the subtlest of black magic, you have to decide what parts of the integrand to treat as $u$ and $\text{d}v$. Typically you make $u$ something that is easy to differentiate, and you make $\text{d}v$ something that is easy to antidifferentiate. Good luck!
...
curve(1 / sqrt(x), from = 0, to = 1, n = 500, col = "red")
```
