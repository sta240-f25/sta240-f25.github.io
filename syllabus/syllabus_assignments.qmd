...
-   **Midterm 1**: when and where;
-   **Midterm 2**: when and where;
-   **Final**: Friday December 12 from 9 AM - 12 PM in Physics 130.

These will be old school, pencil-and-paper, in-class exams. The only resources you are allowed are a simple four-function calculator (which you won't actually need) and a note sheet that you and only you have prepared (both sides of a standard 8.5" x 11" piece of paper).
