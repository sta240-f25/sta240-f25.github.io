...
If you have two vectors and you want to combine them into one, you can just use the `c()` commands again. The "c" stands for "concatenate." You're concatenating, or joint, the vectors end-to-end:
