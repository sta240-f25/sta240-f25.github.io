...
There are `{r} length(playlist)` songs, so if I generate a sample of size `{r} length(playlist)` *without replacement*, I'm just randomly shuffling the contents of that vector:
