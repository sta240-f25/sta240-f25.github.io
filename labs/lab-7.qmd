...
Let $X$ be an absolutely continuous random variable with pdf $f_X$, let and $a,\,b\in\mathbb{R}$ be non-zero constants, and consider the new random variable $Y=aX+b$.
...
So $Y\sim \text{N}(b,\, a^2)$. That's where the general normal comes from. It's just a location-scale transformation of the standard normal.
:::
