...
Gandalf finishes by saying "I expect sixty of the mixed samples to be negative. For the other forty samples, I expect the results to be negative, and hence we will have to test all four hundred of the original samples. This gives a total cost of 460 gold pieces."
