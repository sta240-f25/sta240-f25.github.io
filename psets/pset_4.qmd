...
King Elessar summons the wizard Gandalf to court, seeking his counsel. An evil plague has been sweeping the army barracks and incapacitating the soldiers. King Elessar asks Gandalf if there exists a test for the disease that is 100% sensitive *and* 100% specific. Gandalf says that a perfect blood test does exist, but it is very expensive, requiring the venom of a special lizard found only in the Morgul Vale. Each blood test would cost one gold piece, but the Royal Purse only has 500 gold pieces to spare, and there are 1000 soldiers that need to be tested. Gandalf sleeps on it and returns the next day with a plan for testing all of them that won't break the bank:
